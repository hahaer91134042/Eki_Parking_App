...
public class SublimePicker extends FrameLayout
    ...
    public SublimeTimePicker getTimePicker(){
        return mTimePicker;
    }
    ...
    public void setPostiveBtnTextColor(@ColorInt int c){
        mButtonLayout.mPortraitButtonHandler.positiveBtn.setTextColor(c);
    }
    public void setNegativeBtnTextColor(@ColorInt int c){
        mButtonLayout.mPortraitButtonHandler.negativeBtn.setTextColor(c);
    }
