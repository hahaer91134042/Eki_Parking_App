...
public class SublimeTimePicker extends FrameLayout
    ...
    private CheckedTextView mHourView;
    public CheckedTextView getHourTex(){
        return mHourView;
    }
    private CheckedTextView mMinuteView;
    public CheckedTextView getMinuteTex(){
        return mMinuteView;
    }
    ...
    public void setPickerSelectorColor(@ColorInt int color){
        mRadialTimePickerView.setSelectorColor(color);
    }
    public void setSelectorDotColor(@ColorInt int color){
        mRadialTimePickerView.setSelectorDotColor(color);
    }
    public void setPickerNumBackgroundColor(@ColorInt int color){
        mRadialTimePickerView.setNumBackgroundColor(color);
    }

    private TextView mSeparatorView;
    public void setHeaderTexColor(ColorStateList color){
        ...
        switch (pickerIndex) {
            case HOUR_INDEX:
                if (mAllowAutoAdvance && autoAdvance) {
                    ...
                    mHourView.setChecked(false);
                    mMinuteView.setChecked(true);
