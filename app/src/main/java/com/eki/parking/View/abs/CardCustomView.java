...
public abstract class CardCustomView extends CardView
    ...
    public CardCustomView(@NonNull Context context) {
        this(context,null);
    }

    public CardCustomView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if (setInflatView()!=0){
            itemView=inflater.inflate(setInflatView(),this,setAttachToRoot());//root view 有可能不同類型
            initInFlaterView();
            addView(itemView);
        }
    }
