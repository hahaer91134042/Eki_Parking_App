...
public abstract class ConstrainCustomView extends ConstraintLayout
    ...
    public ConstrainCustomView(Context context) {
        this(context,null);
    }

    public ConstrainCustomView(Context context, AttributeSet attrs) {
        super(context, attrs);
