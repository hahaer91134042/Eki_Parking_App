...
public class FreeNumberPicker extends LinearLayout {
    ...
    void init(AttributeSet attrs) {
        ...
        number=ta.getInteger(R.styleable.FreeNumberPicker_pickerNumber,number);
...
//        etNumber.onWindowFocusChanged(true);
//    }
        ...
        etNumber.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (s.toString().matches(expr)) {
                    ...
                    Log.d("Hill->","input number->"+number);
                    if (number > maxValue) {
                        setNumber(maxValue);
    ...
    public FreeNumberPicker setNumberWidth(float numberWidth) {
        ...
        etNumber.getLayoutParams().width=(int)numberWidth;
        return this;
    }
